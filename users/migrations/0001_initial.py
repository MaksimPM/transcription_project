    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmation_code_created_at', models.DateTimeField(blank=True, null=True, verbose_name='время создания кода')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='время регистрации')),
                ('JWTToken', models.CharField(blank=True, max_length=350, null=True, verbose_name='JWT Token')),
                ('files', models.ManyToManyField(related_name='user_files', to='transcription.file', verbose_name='файлы')),
