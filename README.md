...
<h2 align="center">Сервис для транскрибации и спикеризации медиафайлов</h2>
...
## Возможности сервиса
    ...
    После обработки медиафайла на почту отправляется результат транскрибации с переводом 
    текста на выбранный язык и разделением на спикеров
________________________________________
## Эндпоинты (Endpoints)
